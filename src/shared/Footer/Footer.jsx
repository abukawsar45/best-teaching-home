  ...
  return (
    <footer>
      <div className='grid grid-cols-1 md:grid-cols-2 bg-neutral text-neutral-content'>
        <div className='bg-slate-600 py-10 px-3 lg:px-5 flex flex-col md:flex-row justify-evenly'>
        ...
        <div className='py-10 px-3 lg:px-5 flex flex-col md:flex-row justify-between gap-6 '>
          <div>
          ...
          <div>
            ...
            <div className='flex flex-col gap-4 mt-4'>
              <Link>
                <img src={playstore} className='rounded-md' alt='' />
                <img src={ios} className='my-3 rounded-md' alt='' />
              </Link>
            </div>
          </div>
          <div className=''>
