      ...
      <div className='hidden md:block w-96 relative'>
        ...
        <div className=' mt-4 md:mx-auto py-4 px-2  '>
          ...
          <div
            ...
            className='relative md:flex flex-col justify-start  md:justify-center items-center  h-[200px] md:h-96 lg:h-[400px] w-[200px] md:w-96 lg:w-[400px]  md:mx-auto  z-10 scale-50 md:group-hover:scale-100  transition-transform origin-center rounded-[50%] duration-500 ease-in-out'
          >
            <div
